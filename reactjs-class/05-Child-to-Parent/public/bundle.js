...
/***/ function(module, exports, __webpack_require__) {
	...
	var Parent = React.createClass({
		...
		setParent: function setParent(newClicks) {
			this.setState({
				clicks: newClicks
			});
		},
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'h2',
							null,
							'When Children Rebel: A Tale of Reactive Components'
						),
						React.createElement(
							'p',
							null,
							React.createElement(
								'em',
								null,
								'Children influence parent via callbacks given to them by the parent.'
							)
						)
					),
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement(Child, { setParent: this.setParent })
							)
						)
					)
				)
